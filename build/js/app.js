(() => {
  ...
  // node_modules/.pnpm/lil-gui@0.17.0/node_modules/lil-gui/dist/lil-gui.esm.js
...
@font-face {
  ...
  var Slider = class extends Element {
    ...
    handleGUI() {
      const { GUI: GUI2 } = window;
      this._factor = GUI2._factor;
      this._damping = GUI2._damping;
      this._snapping = GUI2._snapping;
      this._bounds = GUI2._bounds;
    }
    onResize(element) {
